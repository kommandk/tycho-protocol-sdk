...
// Shibaswap handles arbirary amounts, but we limit the amount to 10x just in case
uint256 constant RESERVE_LIMIT_FACTOR = 10;

contract ShibaswapV1SwapAdapter is ISwapAdapter {
    using SafeERC20 for IERC20;

    IShibaswapV1Factory immutable factory;

    constructor(address factory_) {
        factory = IShibaswapV1Factory(factory_);
    }
    ...
    function price(
        ...
        IShibaswapV1Pair pair = IShibaswapV1Pair(address(bytes20(poolId)));
        uint112 r0;
        uint112 r1;
